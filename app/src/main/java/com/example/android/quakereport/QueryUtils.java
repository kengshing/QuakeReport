        ...
        try {
            ...
            for (int i = 0; i <jsonArray.length();i++){
             ...
             JSONObject jsonProperty = jsonObject.getJSONObject("properties");
                ...
                double mMagnitude = jsonProperty.getDouble("mag");
                String mPlace = jsonProperty.getString("place");
                long mTime = jsonProperty.getLong("time");
                String mUrl = jsonProperty.getString("url");

                earthquakes.add(new Earthquake(mMagnitude, mPlace, mTime, mUrl));
